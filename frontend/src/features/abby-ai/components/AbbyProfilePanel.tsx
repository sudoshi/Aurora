  ...
  return (
    <div className="border-t border-border/40 p-4 space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-medium text-foreground">My Clinical Profile</h3>
        <button
      ...
      {profile.research_interests.length > 0 && (
        <div>
          <p className="text-xs text-muted-foreground mb-1">Clinical Interests</p>
      ...
      {profile.research_interests.length === 0 &&
       Object.keys(profile.expertise_domains).length === 0 && (
        <p className="text-xs text-muted-foreground italic">
          Abby is learning about your clinical interests. Keep chatting and she will build your profile automatically.
        </p>
      )}
    </div>
  );
