...
export function AccountSecurityTab() {
  ...
  return (
    <div className="max-w-2xl space-y-8">
      {/* Email (read-only) */}
      <section className="rounded-lg border border-[#1C1C48] bg-[#10102A] p-6 space-y-4">
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-[#2DD4BF]/10">
            <Mail size={18} className="text-[#2DD4BF]" />
          </div>
          <div>
            <h3 className="text-sm font-semibold text-[#E8ECF4]">Email Address</h3>
            <p className="text-xs text-[#7A8298]">Your login email cannot be changed here</p>
          </div>
        </div>
        <div className="space-y-1.5">
          ...
          />
          <p className="text-xs text-[#4A5068]">Contact your administrator to change your email address.</p>
        </div>
      </section>
      ...
      <section className="rounded-lg border border-[#1C1C48] bg-[#10102A] p-6 space-y-5">
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-[#2DD4BF]/10">
            <Lock size={18} className="text-[#2DD4BF]" />
          </div>
          <div>
            <h3 className="text-sm font-semibold text-[#E8ECF4]">Change Password</h3>
            <p className="text-xs text-[#7A8298]">Update your password regularly for security</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            {form.new_password_confirmation && !passwordsMatch && (
              <p className="text-xs text-[#F0607A]">Passwords do not match</p>
            )}
          </div>
        </div>
