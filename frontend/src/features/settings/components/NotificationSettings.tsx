...
const GRANULAR_LABELS: {
...
}[] = [
  {
    ...
    description: "Receive a notification when a clinical analysis finishes successfully",
  },
  {
    key: "analysis_failed",
    label: "Analysis Failed",
    description: "Receive a notification when a clinical analysis encounters an error",
  },
  {
    key: "case_reviewed",
    label: "Case Reviewed",
    description: "Receive a notification when a clinical case review completes",
  },
  {
    key: "study_completed",
