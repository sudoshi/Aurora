...
export function ProfileTab() {
  ...
  return (
    <div className="max-w-2xl space-y-8">
      {/* Avatar */}
      <section className="rounded-lg border border-[#1C1C48] bg-[#10102A] p-6">
        <h3 className="text-sm font-semibold text-[#E8ECF4] mb-4">Profile Photo</h3>
        <AvatarUpload />
      </section>

      {/* Profile Details */}
      <section className="rounded-lg border border-[#1C1C48] bg-[#10102A] p-6 space-y-5">
        <h3 className="text-sm font-semibold text-[#E8ECF4]">Profile Details</h3>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <label className="text-xs font-semibold uppercase tracking-wider text-[#7A8298]">
              Name <span className="text-[#F0607A]">*</span>
            </label>
            <input
              type="text"
              value={form.name}
          ...
          <div className="space-y-1.5 md:col-span-2">
            ...
            <textarea
              ...
              placeholder="A brief description about yourself and your clinical interests..."
            />
            <p className="text-xs text-[#4A5068] text-right">
