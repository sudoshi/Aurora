...
export type ReferenceType = "case" | "patient" | "channel";
...
export interface Announcement {
  ...
  body: string;
  body_html: string | null;
  category: "general" | "case_update" | "data_update" | "milestone" | "policy";
  is_pinned: boolean;
