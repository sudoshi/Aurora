...
const SUGGESTED_PROMPTS = [
  "What clinical patterns have been found in recent cases?",
  "Summarize recent review decisions",
  "Help me draft a case summary",
  "What are common diagnostic considerations for this presentation?",
];
  ...
  return (
    <div className="rounded-xl p-5 mb-4 border border-emerald-700/30 bg-gradient-to-br from-emerald-900/15 via-transparent to-teal-900/15 shadow-[inset_0_1px_0_0_rgba(16,185,129,0.1)]">
      <div className="flex items-start gap-3 mb-3">
        ...
        <div>
          <h3 className="text-sm font-medium text-foreground">
            Hi! I'm Abby, your clinical research companion.
          </h3>
      ...
      <p className="text-[13px] text-muted-foreground leading-relaxed mb-4">
        I have access to Aurora's institutional memory — past discussions,
        case reviews, clinical outcomes, and wiki articles. Ask
        me anything about your cases, and I'll draw on what this team has
        learned.
      </p>
...
export default function AskAbbyChannel() {
  ...
  const handleSend = useCallback(
    ...
    [conversationId, inputValue, isLoading, userName, sendQuery, conversation]
  );
        ...
        <div className="flex items-center gap-3 px-5 py-3 border-b border-white/[0.06] shrink-0 bg-gradient-to-r from-emerald-900/[0.04] to-transparent">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px] text-muted-foreground">
              AI clinical companion · MedGemma · Institutional memory
            </p>
          </div>
        ...
        <div className="shrink-0 px-4 py-3 border-t border-white/[0.06] bg-gradient-to-t from-black/20 to-transparent">
          <div className="flex gap-2">
            <input
              ...
              placeholder="Ask Abby anything about your clinical cases..."
              disabled={isLoading}
