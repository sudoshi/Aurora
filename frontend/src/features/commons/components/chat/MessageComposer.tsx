      ...
      <div className="relative rounded-lg border border-white/[0.08] bg-[#13131a] p-3 shadow-[0_-4px_20px_rgba(0,0,0,0.15)]">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <button
            ...
            className="rounded-md bg-primary px-4 py-1.5 text-xs font-medium text-primary-foreground transition-all duration-150 hover:bg-primary/90 hover:shadow-[0_0_12px_rgba(13,148,136,0.3)] disabled:opacity-40"
          >
            Send
          </button>
        </div>
