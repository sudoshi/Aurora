...
const IMAGES = [
  ...
  { src: "/Abby-AI.png", alt: "Abby - Aurora AI Assistant" },
];
...
export function AboutAbbyModal({ open, onClose }: AboutAbbyModalProps) {
  ...
  const caption = activeIndex === 0
    ...
    : "Abby - AI Clinical Intelligence Assistant";
    ...
    <Modal open={open} onClose={onClose} size="lg">
      <div style={{ padding: "8px 4px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <div
            style={{
              ...
              margin: "0 auto 16px",
              borderRadius: "50%",
              border: "3px solid var(--teal, #2DD4BF)",
          ...
          >
            Aurora's AI Clinical Intelligence Assistant
          </p>
        </div>
        ...
        >
          ...
          <blockquote
            style={{
              borderLeft: "3px solid var(--teal, #2DD4BF)",
              paddingLeft: 20,
              margin: "16px 0",
              fontStyle: "italic",
              fontSize: 18,
        ...
        >
          ...
          >
            Aurora exists for the same reason. Clinical case intelligence —
            patient data, clinical analytics, and decision support — is powerful
            but fragmented across systems. Clinicians spend more time wrestling
            with tools than answering clinical questions. Aurora brings it all
            under one roof, just as Abigail brought modern medicine to a community
            that had none.
          </p>
          <p
            style={{
          ...
          >
            ...
            clinicians analyze patient cases, navigate clinical data, and make
            the complex accessible. She is our small tribute to a woman who
            looked at an impossible problem and said, simply,{" "}
            <em>"I'm going to fix that."</em>
          </p>
        </div>
