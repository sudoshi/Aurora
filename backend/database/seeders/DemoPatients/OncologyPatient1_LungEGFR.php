...
class OncologyPatient1_LungEGFR
{
    ...
    public function seed(): void
    {
        ...
        $this->addProcedure($patient, [
            ...
            'concept_code' => '32405',
            'vocabulary' => 'CPT',
            'performed_date' => '2021-04-14',
            'performer' => 'Interventional Radiology',
            'body_site' => 'Right upper lobe',
        ]);
        ...
        $this->addProcedure($patient, [
            ...
            'concept_code' => '77372',
            'vocabulary' => 'CPT',
            'performed_date' => '2023-05-01',
            'performer' => 'Radiation Oncology',
            'body_site' => 'Brain',
        ]);
        ...
        $biopsyVisit = $this->addVisit($patient, [
            ...
            'admission_date' => '2021-04-14',
            'department' => 'Interventional Radiology',
            'attending_provider' => 'Dr. Nina Zhao',
        ]);

        $oncologyInitial = $this->addVisit($patient, [
            'visit_type' => 'outpatient',
            'admission_date' => '2021-04-28',
            'department' => 'Medical Oncology',
            'attending_provider' => 'Dr. Catherine Park',
        ]);
        ...
        $neuroVisit = $this->addVisit($patient, [
            'visit_type' => 'outpatient',
            'admission_date' => '2021-05-05',
            'department' => 'Neuro-oncology',
            'attending_provider' => 'Dr. Steven Liu',
        ]);
        ...
        $this->addVisit($patient, [
            ...
            'department' => 'Emergency Medicine',
            'attending_provider' => 'Dr. James Wong',
        ]);
        ...
        $this->addImagingMeasurement($ct1, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Subcarinal LN',
            'value_numeric' => 21,
            'unit' => 'mm',
            'measured_by' => 'Dr. Robert Chen',
            'measured_at' => '2021-04-12',
        ...
        $this->addImagingMeasurement($ct1, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Right adrenal metastasis',
            'value_numeric' => 15,
            'unit' => 'mm',
            'measured_by' => 'Dr. Robert Chen',
            'measured_at' => '2021-04-12',
        ...
        $this->addImagingMeasurement($ct6, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Left adrenal nodule (new)',
            'value_numeric' => 6,
            'unit' => 'mm',
            'measured_by' => 'Dr. Robert Chen',
            'measured_at' => '2023-04-12',
        ...
        $this->addImagingMeasurement($ct7, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Left adrenal nodule',
            'value_numeric' => 4,
            'unit' => 'mm',
            'measured_by' => 'Dr. Robert Chen',
            'measured_at' => '2023-06-22',
        ...
        $this->addImagingMeasurement($ct9, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Mediastinal LN (new)',
            'value_numeric' => 12,
            'unit' => 'mm',
            'measured_by' => 'Dr. Robert Chen',
            'measured_at' => '2024-07-15',
        ...
        $this->addImagingMeasurement($ct10, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Mediastinal LN',
            'value_numeric' => 8,
            'unit' => 'mm',
            'measured_by' => 'Dr. Robert Chen',
            'measured_at' => '2025-01-20',
        ...
        $this->addImagingMeasurement($ct10, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Liver metastasis segment VI',
            'value_numeric' => 11,
            'unit' => 'mm',
            'measured_by' => 'Dr. Robert Chen',
            'measured_at' => '2025-01-20',
        ...
        $this->addImagingMeasurement($ct12, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Peritoneal nodule (new)',
            'value_numeric' => 11,
            'unit' => 'mm',
            'measured_by' => 'Dr. Robert Chen',
            'measured_at' => '2026-01-15',
        ...
        $this->addImagingMeasurement($mri1, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Right frontal brain metastasis',
            'value_numeric' => 12,
            'unit' => 'mm',
        ...
        $this->addImagingMeasurement($mri1, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Left parietal brain metastasis',
            'value_numeric' => 8,
            'unit' => 'mm',
            'measured_by' => 'Dr. Steven Liu',
            'measured_at' => '2021-04-13',
        ...
        $this->addConditionEra($patient, [
            'concept_name' => 'Lung adenocarcinoma',
        ...
        $this->addConditionEra($patient, [
            'concept_name' => 'Treatment toxicity (chemotherapy)',
