...
class OncologyPatient3_TNBC_BRCA1
{
    ...
    public function seed(): void
    {
        ...
        $this->addProcedure($patient, [
            ...
            'concept_code' => '19083',
            'vocabulary' => 'CPT',
            'performed_date' => '2021-09-22',
            'performer' => 'Breast Surgery',
            'body_site' => 'Left breast',
        ]);
        ...
        $this->addProcedure($patient, [
            ...
            'concept_code' => '89258',
            'vocabulary' => 'CPT',
            'performed_date' => '2021-10-10',
            'performer' => 'Reproductive Endocrinology',
        ]);
        ...
        $neoInitVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Rajesh Gupta',
        ]);
        ...
        $surgeryVisit = $this->addVisit($patient, [
            ...
            'admission_date' => '2022-03-28',
            'discharge_date' => '2022-03-31',
            'department' => 'Breast Surgery',
            'attending_provider' => 'Dr. Anita Desai',
        ]);
        ...
        $colitisVisit = $this->addVisit($patient, [
            ...
            'discharge_date' => '2022-09-20',
            'department' => 'Emergency Medicine',
            'attending_provider' => 'Dr. James Walker',
        ]);
        ...
        $this->addImagingMeasurement($mri1, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Left axillary lymph node',
            'value_numeric' => 18,
            'unit' => 'mm',
            'measured_by' => 'Dr. Sunita Rao',
            'measured_at' => '2021-09-25',
        ...
        $this->addImagingMeasurement($ct1, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Left lung nodule',
            'value_numeric' => 28,
            'unit' => 'mm',
            'measured_by' => 'Dr. Sunita Rao',
        ...
        $this->addImagingMeasurement($ct1, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Right axillary lymph node',
            'value_numeric' => 14,
            'unit' => 'mm',
            'measured_by' => 'Dr. Sunita Rao',
            'measured_at' => '2024-06-14',
        ...
        $this->addImagingMeasurement($ct5, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Left adrenal mass (NEW)',
            'value_numeric' => 16,
            'unit' => 'mm',
            'measured_by' => 'Dr. Sunita Rao',
            'measured_at' => '2025-12-15',
        ...
        $this->addImagingMeasurement($ct6, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Left adrenal mass',
            'value_numeric' => 10,
            'unit' => 'mm',
            'measured_by' => 'Dr. Sunita Rao',
            'measured_at' => '2026-03-10',
        ...
        $this->addGenomicVariant($patient, [
            'gene' => 'MYC',
            'variant' => 'Amplification (14 copies)',
            'variant_type' => 'CNV',
            'chromosome' => 'chr8',
            'clinical_significance' => 'pathogenic',
        ...
        $this->addGenomicVariant($patient, [
            'gene' => 'BRCA1',
            'variant' => 'c.5264_5266del (reversion mutation, acquired resistance)',
            'variant_type' => 'indel',
            'chromosome' => 'chr17',
        ...
        $this->addConditionEra($patient, [
            'concept_name' => 'Breast cancer era',
            'era_start' => '2021-09-01',
            'era_end' => null,
            'occurrence_count' => 25,
        ]);

        $this->addConditionEra($patient, [
            'concept_name' => 'BRCA1 carrier management era',
            'era_start' => '2021-10-01',
            'era_end' => null,
            'occurrence_count' => 6,
        ]);

        $this->addConditionEra($patient, [
            'concept_name' => 'Treatment toxicity era (neoadjuvant)',
            'era_start' => '2021-10-01',
            'era_end' => '2022-04-30',
            'occurrence_count' => 5,
        ]);
        ...
        $this->addDrugEra($patient, [
            'drug_name' => 'KEYNOTE-522 neoadjuvant',
            'era_start' => '2021-10-18',
            'era_end' => '2022-03-14',
            'gap_days' => 0,
        ]);

        $this->addDrugEra($patient, [
            'drug_name' => 'Pembrolizumab adjuvant',
            'era_start' => '2022-05-02',
            'era_end' => '2023-02-20',
            'gap_days' => 21,
        ]);
