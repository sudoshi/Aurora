...
class OncologyPatient2_CRC_BRAF
{
    ...
    public function seed(): void
    {
        ...
        $this->addProcedure($patient, [
            ...
            'concept_code' => '49083',
            'vocabulary' => 'CPT',
            'performed_date' => '2025-05-15',
            'performer' => 'Gastroenterology',
            'body_site' => 'Abdomen',
        ]);
        ...
        $surgVisit = $this->addVisit($patient, [
            ...
            'admission_date' => '2022-02-08',
            'department' => 'Surgical Oncology',
            'attending_provider' => 'Dr. Adaeze Nwosu',
        ]);

        // Post-surgical follow-up
        $this->addVisit($patient, [
            'visit_type' => 'outpatient',
            'admission_date' => '2022-02-22',
            'department' => 'Surgical Oncology',
            'attending_provider' => 'Dr. Adaeze Nwosu',
        ]);
        ...
        $adjuvantVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Thomas Reyes',
        ]);

        // Adjuvant monitoring
        $this->addVisit($patient, [
            'visit_type' => 'outpatient',
            'admission_date' => '2022-04-15',
            'department' => 'Medical Oncology',
            'attending_provider' => 'Dr. Thomas Reyes',
        ]);
        ...
        $liverBiopsyVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Lisa Huang',
        ]);

        $metRecurrenceVisit = $this->addVisit($patient, [
            'visit_type' => 'outpatient',
            'admission_date' => '2022-12-20',
            'department' => 'Medical Oncology',
            'attending_provider' => 'Dr. Thomas Reyes',
        ]);
        ...
        $palliativeVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Karen Mitchell',
        ]);
        ...
        $this->addImagingMeasurement($ct4, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Liver seg2 (new)',
            'value_numeric' => 14,
            'unit' => 'mm',
            'measured_by' => 'Dr. Lisa Huang',
            'measured_at' => '2023-09-20',
        ...
        $this->addImagingMeasurement($ct7, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Retroperitoneal LN (new)',
            'value_numeric' => 22,
            'unit' => 'mm',
            'measured_by' => 'Dr. Lisa Huang',
            'measured_at' => '2024-09-18',
        ...
        $this->addImagingMeasurement($ct8, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'Retroperitoneal LN',
            'value_numeric' => 24,
            'unit' => 'mm',
            'measured_by' => 'Dr. Lisa Huang',
            'measured_at' => '2025-02-14',
        ...
        $this->addImagingMeasurement($ct9, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'RLL lung nodule (new)',
            'value_numeric' => 14,
            'unit' => 'mm',
            'measured_by' => 'Dr. Lisa Huang',
            'measured_at' => '2025-06-20',
        ...
        $this->addImagingMeasurement($ct9, [
            'measurement_type' => 'RECIST',
            'target_lesion' => true,
            'measurement_type' => 'LLL lung nodule (new)',
            'value_numeric' => 11,
            'unit' => 'mm',
            'measured_by' => 'Dr. Lisa Huang',
            'measured_at' => '2025-06-20',
        ...
        $this->addConditionEra($patient, [
            'concept_name' => 'Colorectal cancer era',
        ...
        $this->addConditionEra($patient, [
            'concept_name' => 'Liver metastases era',
            'era_start' => '2022-12-01',
            'era_end' => null,
            'occurrence_count' => 12,
        ]);

        $this->addConditionEra($patient, [
            'concept_name' => 'Treatment toxicity era',
            'era_start' => '2023-01-01',
            'era_end' => '2023-04-01',
            'occurrence_count' => 3,
        ]);
