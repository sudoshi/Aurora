...
class PreSurgicalPatient3_VHL_HHT
{
    ...
    public function seed(): void
    {
        ...
        $neuroVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Anders Bergström',
        ]);
        ...
        $neuroradVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Kenji Tanaka',
        ]);
        ...
        $pulmVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Claire Dupont',
        ]);
        ...
        $hemeVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Nadia Petrov',
        ]);
        ...
        $geneticsVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Sarah Whitfield',
        ]);
        ...
        $ophthVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. David Okafor',
        ]);
        ...
        $anesthVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Lisa Chang',
        ]);
        ...
        $entVisit = $this->addVisit($patient, [
            ...
            'attending_provider' => 'Dr. Henrik Johansson',
        ]);
        ...
        $this->addImagingMeasurement($abdMri, [
            'measurement_type' => 'Hepatic AVM diameter',
            'value_numeric' => 2.3,
            'unit' => 'cm',
        ]);
        ...
        $this->addConditionEra($patient, [
            'concept_name' => 'VHL surveillance era',
        ...
        $this->addConditionEra($patient, [
            'concept_name' => 'HHT management era',
        ...
        $this->addConditionEra($patient, [
            'concept_name' => 'Chronic hypoxemia era',
