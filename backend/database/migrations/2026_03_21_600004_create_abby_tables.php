...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('abby_user_profiles', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->foreignId('user_id')->unique()->constrained('users')->onDelete('cascade');
            $table->jsonb('research_interests')->default('[]');
            $table->jsonb('expertise_domains')->default('{}');
            $table->jsonb('interaction_preferences')->default('{}');
            $table->jsonb('frequently_used')->default('{}');
    ...
    {
        Schema::dropIfExists('abby_user_profiles');
