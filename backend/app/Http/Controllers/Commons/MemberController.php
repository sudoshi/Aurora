...
class MemberController extends Controller
{
    ...
    public function unreadCounts(Request $request): JsonResponse
    {
        ...
        // Get channels the user is a member of with their last_read_at
        $members = ChannelMember::where('user_id', $user->id)->get();

        $counts = [];
        foreach ($members as $member) {
            $query = \App\Models\Commons\Message::where('channel_id', $member->channel_id)
