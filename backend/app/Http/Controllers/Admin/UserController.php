...
class UserController extends Controller
{
        ...
        if ($sendTemp) {
            ...
            try {
                Http::withHeaders([
                    ...
                    'html' => "<p>Hello {$user->name},</p><p>Your temporary password is: <strong>{$plainPassword}</strong></p><p>You will be required to change it on first login.</p>",
                ]);
            } catch (\Throwable $e) {
    ...
    {
        $lastActive = $user->last_active_at ?? $user->last_login_at ?? null;
