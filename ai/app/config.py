...
class Settings(BaseSettings):
    ...
    ollama_model: str = "medgemma-q4:latest"
    ollama_timeout: int = 120

    # SapBERT model (for embedding generation)
    ...
    # Claude API (hybrid LLM routing)
    claude_api_key: str = ""
    claude_model: str = "claude-sonnet-4-20250514"
    claude_max_tokens: int = 4096
    claude_timeout: int = 60

    # PHI sanitization (data governance)
    ...
    agency_api_base_url: str = "https://aurora.acumenus.net"
