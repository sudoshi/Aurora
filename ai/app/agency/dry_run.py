...
TOOL_DESCRIPTIONS: dict[str, Any] = {
    "case_lookup": lambda step: {
        "would_fetch": "case",
        "case_id": step.parameters.get("case_id"),
    },
    "patient_search": lambda step: {
        "would_search": "patients",
        "query": step.parameters.get("query"),
    },
    "compare_cases": lambda step: {
        "would_compare": "cases",
        "case_a_id": step.parameters.get("case_a_id"),
        "case_b_id": step.parameters.get("case_b_id"),
    },
    "export_results": lambda step: {
        "would_export": "results",
        "format": step.parameters.get("format", "json"),
    },
    "session_create": lambda step: {
        "would_create": "session",
        "case_id": step.parameters.get("case_id"),
        "title": step.parameters.get("title"),
    },
    "decision_propose": lambda step: {
        "would_propose": "decision",
        "case_id": step.parameters.get("case_id"),
        "decision_type": step.parameters.get("decision_type"),
    },
    "team_add_member": lambda step: {
        "would_add": "team_member",
        "team_id": step.parameters.get("team_id"),
        "user_id": step.parameters.get("user_id"),
    },
    "note_create": lambda step: {
        "would_create": "note",
        "case_id": step.parameters.get("case_id"),
    },
    "run_patient_analysis": lambda step: {
        "would_run": "patient_analysis",
        "patient_id": step.parameters.get("patient_id"),
    },
    "run_risk_assessment": lambda step: {
        "would_run": "risk_assessment",
        "patient_id": step.parameters.get("patient_id"),
    },
