"""Ollama client for MedGemma integration.

Provides health checks and LLM generation for clinical case analysis.
"""
...
CONCEPT_MAPPING_PROMPT = """You are a medical terminology expert specializing in clinical case analysis. Given a clinical term, suggest the most appropriate SNOMED/ICD-10/LOINC standard concept mapping for use in tumor board discussions and multidisciplinary review.
...
{{
  ...
  "reasoning": "brief explanation of why this mapping is appropriate for clinical case intelligence"
}}
"""
