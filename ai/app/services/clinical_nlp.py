...
Ported from Parthenon's medcat service, adapted for Aurora's clinical case
intelligence platform. Uses regex pattern matching for medical entity extraction
and SapBERT for concept linking.
"""
